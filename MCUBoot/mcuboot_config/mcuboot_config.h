...
#define BOOT_HEADER_SIZE                    0x400

/* ── Anti-rollback basé sur le numéro de version ── */
#define MCUBOOT_DOWNGRADE_PREVENTION        1   /* ← AJOUTER */
...
/* ── Logging ── */
#include <stdio.h>
#define MCUBOOT_LOG_ERR(_fmt, ...) printf("[MCUBoot][ERR] " _fmt "\r\n", ##__VA_ARGS__)
#define MCUBOOT_LOG_INF(_fmt, ...) printf("[MCUBoot][INF] " _fmt "\r\n", ##__VA_ARGS__)
#define MCUBOOT_LOG_DBG(_fmt, ...) printf("[MCUBoot][DBG] " _fmt "\r\n", ##__VA_ARGS__)

/* ── Crypto ── */
#define MCUBOOT_SIGN_EC256                  1
#define MCUBOOT_USE_MBED_TLS               1
#define MCUBOOT_FIH_PROFILE_OFF            1
#define MCUBOOT_NO_CRYPTO                   0
...
//
///* ================================================================
// * ANTI-ROLLBACK (Downgrade Prevention)
// * ================================================================ */
////#define MCUBOOT_DOWNGRADE_PREVENTION    1     /* ← ACTIVÉ */
////#define MCUBOOT_HW_ROLLBACK_PROT        0     /* On garde 0 pour l'instant (version logicielle simple) */
////#define MCUBOOT_DOWNGRADE_PREVENTION_SECURITY_COUNTER 1   /* 0 = mode version simple (ce que tu veux) */
//
